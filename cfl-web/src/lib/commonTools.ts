...
export const commonTools: CommonTool[] = [
  ...
  { value: "slugifyLink", label: "Link Slugify", description: "Create a URL path slug from a link.", inputs: [{ name: "link", label: "Link", placeholder: "https://example.com/docs/My Page" }], resultKey: "slug" },
