    ...
    <section className={`relative flex h-full flex-col overflow-hidden ${expanded ? "chrome-panel w-full rounded-lg border-2 border-[var(--secondary)] shadow-2xl" : "w-full"}`}>
      ...
      <footer className="flex flex-wrap items-center justify-between gap-3 border-t-2 border-[var(--secondary)] bg-black/10 px-3 py-3 sm:px-6">
        ...
        <div className="grid w-full gap-2 sm:w-auto sm:grid-cols-3 sm:gap-3">
          <div className="tool-card flex items-center justify-between gap-3 rounded-xl border border-[var(--secondary)] px-3 py-2 transition-transform hover:-translate-y-0.5">
            <div>
              <p className="text-[0.6rem] font-black uppercase tracking-[0.14em] opacity-70">Randomize</p>
              <p className="text-xs font-black">Shuffle style</p>
            </div>
