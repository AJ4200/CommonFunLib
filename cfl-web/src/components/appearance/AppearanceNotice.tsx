...
const AppearanceNotice: React.FC = () => {
  ...
  return (
    <div className="appearance-notice pointer-events-none fixed bottom-[4.15rem] left-1/2 z-[1100] w-[min(94vw,34rem)] -translate-x-1/2 overflow-hidden rounded-2xl border-2 border-[var(--secondary)] text-[var(--foreground)] shadow-2xl sm:bottom-[4.9rem]">
      <div
      ...
      />
      <div className="relative bg-black/15 px-4 py-3.5 backdrop-blur-md sm:px-5 sm:py-4">
        <div className="flex items-center justify-between gap-3 border-b border-current/20 pb-2.5">
          <div className="flex items-center gap-2 text-xs font-black uppercase tracking-[0.2em] opacity-75 sm:text-sm">
