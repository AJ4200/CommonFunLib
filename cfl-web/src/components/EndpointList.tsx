...
const EndpointList = ({ endpoints }: EndpointListProps) => {
  ...
  return (
    <div className="grid h-full min-h-0 gap-4 lg:grid-cols-[minmax(15rem,0.32fr)_minmax(0,1fr)]">
      <aside className="tool-card min-w-0 rounded-lg border border-[var(--secondary)] p-4">
        ...
        <label className="field-label">
          ...
          <span className="relative block">
            ...
            <input
              className="control-surface pl-10 placeholder:text-current/45"
              value={query}
        ...
        <div className="mt-4 grid gap-2 text-xs font-black uppercase">
      ...
      <div className="flex min-h-0 flex-col gap-3 overflow-y-auto pr-2 custome-scroll">
