...
const common = {
  ...
  isLeapYear: CommonFunctions.isLeapYear,
...
const generate = {
  ...
  randomDate: (start, end) => generator.generateRandomDate(start, end),
...
const convert = {
  ...
  volume: (value, fromUnit, toUnit) => converter.convertVolume(value, fromUnit, toUnit),
...
const api = {
  ...
  generateRandomDate: generate.randomDate,
