...
export class Generator {
  ...
  generateRandomDate(start?: string, end?: string): string;
...
export class Converter {
  ...
  convertVolume(value: number, fromUnit: string, toUnit: string): string | null;
...
export class Hashing {
  ...
  static sha3_384(input: string): string;
...
export const common: {
  ...
  isLeapYear: typeof CommonFunctions.isLeapYear;
...
export const convert: {
  ...
  volume(value: number, fromUnit: string, toUnit: string): string | null;
...
export const hash: {
  ...
  sha3_384: typeof Hashing.sha3_384;
...
export const isLeapYear: typeof CommonFunctions.isLeapYear;
...
export const generateRandomDate: typeof generate.randomDate;
...
export const convertVolume: typeof convert.volume;
...
export const sha3_384: typeof Hashing.sha3_384;
